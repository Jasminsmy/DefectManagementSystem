...
<link rel="stylesheet" href="client/editprofile.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-custom-color-1 u-header u-header" id="sec-e826"><a href="/clientindex" class="u-border-none u-btn u-button-style u-none u-btn-1"></a><a href="/clientindex" class="u-image u-logo u-palette-1-base u-image-1" data-image-width="1920" data-image-height="1080">
    ...
    <section class="u-clearfix u-palette-3-light-3 u-section-1" id="sec-6352">
      <div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">

          <form action="{{ route('profile.post') }}" method="POST" class="u-clearfix u-form-spacing-7 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            <div class="u-form-group u-form-name">
              <label for="name-4c93" class="u-label">Full Name</label>
              <input type="text" id="name-4c93" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="{{ Auth::user()->name }}">
              
            </div>
            <div class="u-form-email u-form-group u-form-partition-factor-2">
              <label for="email-4c93" class="u-label">Email</label>
              <input type="email" id="email-4c93" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="{{ Auth::user()->email }}">
            ...
            <div class="u-form-group u-form-partition-factor-2 u-form-textarea u-form-group-3">
              ...
              <input rows="4" cols="50" id="textarea-f10a" name="phone" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" type="text" value="{{ Auth::user()->phone }}">
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-4c93" class="u-label">Address</label>
              <input rows="4" cols="50" id="textarea-f10a" name="address" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="{{ Auth::user()->address }}" type="text">
              <!--<textarea rows="4" cols="50" id="message-4c93" name="address" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="{{ Auth::user()->address }}" required="" type="text"></textarea>-->
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-custom-color-1 u-hover-white u-text-hover-black u-btn-1">Submit</a>

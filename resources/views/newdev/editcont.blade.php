        ...
        <div class="row tm-content-row tm-mt-big">
            <div class="tm-col tm-col-big">
                <div class="bg-white tm-block">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="{{ url('updateuser',$data->id) }}" method="POST" class="tm-signup-form">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Account Name</label>
                                    <input id="name" name="name" type="text" class="form-control validate" value="{{$data->name}}">
                                </div>
                                <div class="form-group">
                                    <label for="email">Account Email</label>
                                    <input id="email" name="email" type="email" class="form-control validate" value="{{$data->email}}">
                                </div>
                                <div class="form-group">
                                    <label for="address">Address</label>
                                    <input id="address" name="address" type="text" class="form-control validate" value="{{$data->address}}">
                                </div>
                                <div class="form-group">
                                    <label for="phone">Phone</label>
                                    <input id="phone" name="phone" type="tel" class="form-control validate" value="{{$data->phone}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-8 tm-btn-right">
                                        <a href="{{url('/deletecont',$data->id)}}">Delete Account</a>
                                        </button>
                                    </div>
                                </div>

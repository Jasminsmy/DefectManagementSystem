                ...
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-4 tm-edit-product-row">
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="{{ route('defect.post') }}" method="POST" class="tm-edit-product-form">
                                @csrf
                                <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" name="name" id="name">
                                        <option selected>Select one</option>
                                        @foreach ($member as $key => $houseowner)
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="address" name="address" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" required="required">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" name="location" id="location">
                                        ...
                                        <option value="Mastere Bedroom">Master Bedroom</option>

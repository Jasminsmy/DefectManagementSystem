            ...
            <div class="col-12">
                <nav class="navbar navbar-expand-xl navbar-light bg-light">
                    <a class="navbar-brand" href="{{url('dashboard')}}">
                        ...
                        <h1 class="tm-site-title mb-0">DLMScont</h1>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="/contprofile" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    Profile
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/contprofile">Profile</a>
                                    <a class="dropdown-item" href="/conteditpass">Edit Password</a>
                                </div>
                            </li>
                        </ul>
                        <ul class="navbar-nav">
        ...
        <div class="row tm-mt-big">
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">Defect Report</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-12">
                            <form action="" method="POST" class="tm-edit-product-form">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="comment" name="comment" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7" value="{{$data->comment}}" readonly >
                                </div>
                                <div class="input-group mb-3">
                                    <label for="cont" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Contractor
                                    </label>
                                    <input id="contractor" name="contractor" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7" value="{{$data->contractor}}" readonly >
                                </div>
                                <div class="input-group mb-3">
                                    <label for="stats" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Status
                                    </label>
                                    <input id="status" name="status" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-7 col-sm-7" value="{{$data->status}}" readonly>
                                </div>
                            </form>
                                <div class="input-group mb-3">
                                    <div class="ml-auto col-xl-8 col-lg-8 col-md-8 col-sm-7 pl-0">
                                        <button class="btn btn-primary"><a href="{{url('contdefectedit', $data->id)}}">Edit</a>
                                        </button>
                                    </div>
                                </div>
                        </div>
